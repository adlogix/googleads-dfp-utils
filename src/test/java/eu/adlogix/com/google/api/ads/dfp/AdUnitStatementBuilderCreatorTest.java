...
import com.google.api.ads.dfp.axis.v201805.Statement;
...
public class AdUnitStatementBuilderCreatorTest {
	...
	private AdUnitStatementBuilderCreator<StatementBuilder> providerItem_withId_equal() {
		return new AdUnitStatementBuilderCreator<StatementBuilder>(DfpVersion.V_201805).withId("test_id", StatementCondition.EQUAL);
	}

	private AdUnitStatementBuilderCreator<StatementBuilder> providerItem_withId_not_equal() {
		return new AdUnitStatementBuilderCreator<StatementBuilder>(DfpVersion.V_201805).withId("test_id", StatementCondition.NOT_EQUAL);
	}

	private AdUnitStatementBuilderCreator<StatementBuilder> providerItem_withIds() {
		return new AdUnitStatementBuilderCreator<StatementBuilder>(DfpVersion.V_201805).withIds(Arrays.asList(new String[] {
				"Hello", "World" }));
	}
}